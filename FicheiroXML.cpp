#include "FicheiroXML.h"

FicheiroXML::FicheiroXML(tm* _data, int _tamanho, string _caminho, string _nome)
...
FicheiroXML::~FicheiroXML()
{
    //dtor
}

void FicheiroXML::EscreverXML(ofstream& File, int Espacos)
{
